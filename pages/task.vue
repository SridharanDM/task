<template>
  <div class="">
    <div class="relative z-10 bg-indigo-950 py-14 md:py-16 xl:py-20">
      <div class="bg-blue-600 absolute top-0 right-0 z-[-1] h-full w-1/2"></div>
        ...
        <div class="flex flex-wrap items-center -mx-4">
          <div class="w-full px-4">
            <div class="mx-auto max-w-[550px] text-center">
              ...
              <h2
                class="mb-6 text-[30px] font-semibold text-white md:text-[40px]"
              >
                Digital Agency
              </h2>
              <p
              ...
              <a
                ...
                class="inline-flex items-center justify-center px-6 py-3 mb-2 text-base font-medium text-center transition bg-white rounded text-dark hover:bg-opacity-90"
              >
                Discover More
              </a>
            </div>
      ...
      <span class="absolute bottom-0 -translate-x-1/2 left-1/2">
        <svg
          width="77"
          height="77"
          viewBox="0 0 77 77"
